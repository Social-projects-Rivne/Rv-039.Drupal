...
/* themes/dedrone/templates/field/field--field-shared-h1-title.html.twig */
class __TwigTemplate_2b95b952523d63fc1568ad5384ce9b774b2f074cdf6b3e030c442f3bf433949b extends Twig_Template
{
...
";
    ...
    {
        return "themes/dedrone/templates/field/field--field-shared-h1-title.html.twig";
    }
...
{% if label_hidden %}
  {% if multiple %}
    <div{{ attributes.addClass(classes, 'field__items') }}>
      {% for item in items %}
        <div{{ item.attributes.addClass('field__item') }}><h1>{{ item.content|raw }}</h1></div>
      {% endfor %}
    </div>
  {% else %}
    {% for item in items %}
      <div{{ attributes.addClass(classes, 'field__item') }}><h1>{{ item.content|raw }}</h1></div>
    {% endfor %}
  {% endif %}
{% else %}
...
{% endif %}
", "themes/dedrone/templates/field/field--field-shared-h1-title.html.twig", "/app/web/themes/dedrone/templates/field/field--field-shared-h1-title.html.twig");
    }
}
